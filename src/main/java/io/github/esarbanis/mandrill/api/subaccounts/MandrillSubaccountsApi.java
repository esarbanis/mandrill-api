package io.github.esarbanis.mandrill.api.subaccounts;
...
public class MandrillSubaccountsApi extends MandrillSubContext {
	private final String key;
	private final String rootUrl;

	public MandrillSubaccountsApi(final String key, final String url, RequestDispatcher requestDispatcher, JsonSerializer jsonSerializer) {
	...
	public MandrillSubaccountInfo[] list(final String q) 
		...
		params.put("q", q);
		return query(rootUrl+ "subaccounts/list.json", 
	...
	public MandrillSubaccountInfo add(final String id, final String name, 
		...
		return query(rootUrl+ "subaccounts/add.json", 
				params, MandrillSubaccountInfo.class);
	...
	public MandrillSubaccountInfo info(final String id) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("id", id);
		return query(rootUrl+ "subaccounts/info.json", 
				params, MandrillSubaccountInfo.class);
	...
	public MandrillSubaccountInfo update(final String id, 
		...
		return query(rootUrl+ "subaccounts/update.json", 
				params, MandrillSubaccountInfo.class);
	...
	public MandrillSubaccountInfo delete(final String id) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("id", id);
		return query(rootUrl+ "subaccounts/delete.json", 
				params, MandrillSubaccountInfo.class);
	...
	public MandrillSubaccountInfo pause(final String id) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("id", id);
		return query(rootUrl+ "subaccounts/pause.json", 
				params, MandrillSubaccountInfo.class);
	...
	public MandrillSubaccountInfo resume(final String id) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("id", id);
		return query(rootUrl+ "subaccounts/resume.json", 
				params, MandrillSubaccountInfo.class);
