 ...
 * 
 */
package io.github.esarbanis.mandrill.api.messages;
...
public class MandrillMessagesApi extends MandrillSubContext {
	...
	public MandrillMessageStatus[] send(final MandrillMessage m, 
		...
		return query(rootUrl+ "messages/send.json", 
	...
	public MandrillMessageInfo[] search(
		...
		return query(rootUrl+ "messages/search.json", 
	...
	public MandrillTimeSeries[] searchTimeSeries(
		...
		return query(rootUrl+ "messages/search-time-series.json", 
	...
	public MandrillMessageInfo info(final String id) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("id", id);
		return query(rootUrl+ "messages/info.json", 
				params,	MandrillMessageInfo.class);
    ...
    public MandrillMessageContent content(final String id)
        ...
        final HashMap<String,Object> params = paramsWithKey(key);
        params.put("id", id);
        return query(rootUrl+ "messages/content.json",
	...
	public MandrillMessage parse(final String rawMessage) 
		...
		return query(rootUrl+ "messages/parse.json",
	...
	public MandrillMessageStatus[] sendRaw(final String fromEmail, 
		...
		return query(rootUrl+ "messages/send-raw.json", 
				params,	MandrillMessageStatus[].class);
	...
	public MandrillScheduledMessageInfo[] listScheduled(final String to)
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("to", to);
		return query(rootUrl+ "messages/list-scheduled.json", 
	...
	public MandrillScheduledMessageInfo cancelScheduled(final String id) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("id", id);
		return query(rootUrl+ "messages/cancel-scheduled.json", 
				params,	MandrillScheduledMessageInfo.class);
	...
	public MandrillScheduledMessageInfo reschedule(final String id, 
		...
		return query(rootUrl+ "messages/reschedule.json", 
				params,	MandrillScheduledMessageInfo.class);
