 ...
 * 
 */
package io.github.esarbanis.mandrill.api.exports;
...
public class MandrillExportsApi extends MandrillSubContext {
	...
	public MandrillExportsApi(final String key, final String url, final RequestDispatcher requestDispatcher, final JsonSerializer jsonSerializer) {
	...
	public MandrillExportJobInfo info(final String id) 
		...
		params.put("id", id);
		return query(rootUrl+ "exports/info.json",
	...
	public MandrillExportJobInfo list() 
		...
		return query(rootUrl+ "exports/list.json",
				paramsWithKey(key),
	...
	public MandrillExportJobInfo rejects(final String notifyEmail) 
		...
		return query(rootUrl+ "exports/rejects.json",
				params, MandrillExportJobInfo.class);
	...
	public MandrillExportJobInfo whitelist(final String notifyEmail) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("notify_email", notifyEmail);
		return query(rootUrl+ "exports/whitelist.json",
				params, MandrillExportJobInfo.class);
	...
	public MandrillExportJobInfo activity(final String notifyEmail, 
		...
		return query(rootUrl+ "exports/activity.json",
				params, MandrillExportJobInfo.class);
