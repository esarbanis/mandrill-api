 ...
 * 
 */
package org.esarbanis.mandrill.api.ips;
...
import org.esarbanis.mandrill.api.ips.MandrillDedicatedIp.MandrillDnsCheck;
...
public class MandrillIpsApi extends MandrillSubContext {
	...
	public MandrillDedicatedIp[] list() 
		...
		return query(rootUrl+ "ips/list.json",
				paramsWithKey(key),
	...
	public MandrillDedicatedIp info(final String ip) 
		...
		params.put("ip", ip);
		return query(rootUrl+ "ips/info.json", 
	...
	public Date provision(final Boolean warmup, final String pool) 
		...
		return query(rootUrl+ "ips/provision.json", 
	...
	public MandrillDedicatedIp startWarmup(final String ip) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("ip", ip);
		return query(rootUrl+ "ips/start-warmup.json", 
				params, MandrillDedicatedIp.class);
	...
	public MandrillDedicatedIp cancelWarmup(final String ip) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("ip", ip);
		return query(rootUrl+ "ips/cancel-warmup.json", 
				params, MandrillDedicatedIp.class);
	...
	public MandrillDedicatedIp setPool(final String ip, 
		...
		return query(rootUrl+ "ips/set-pool.json", 
				params, MandrillDedicatedIp.class);
	...
	public Boolean delete(final String ip) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("ip", ip);
		return query(rootUrl+ "ips/delete.json", 
	...
	public MandrillDedicatedIpPool[] listPools() 
		...
		return query(rootUrl+ "ips/list-pools.json", 
				paramsWithKey(key),
	...
	public MandrillDedicatedIpPool poolInfo(final String pool) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("pool", pool);
		return query(rootUrl+ "ips/pool-info.json", 
	...
	public MandrillDedicatedIpPool createPool(final String pool) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("pool", pool);
		return query(rootUrl+ "ips/create-pool.json", 
				params, MandrillDedicatedIpPool.class);
	...
	public Boolean deletePool(final String pool) 
		...
		final HashMap<String,Object> params = paramsWithKey(key);
		params.put("pool", pool);
		return query(rootUrl+ "ips/delete-pool.json", 
	...
	public MandrillDnsCheck checkCustomDns(final String ip, 
		...
		return query(rootUrl+ "ips/check-custom-dns.json", 
	...
	public MandrillDedicatedIp setCustomDns(final String ip, 
		...
		params.put("ip", ip);
		params.put("domain", domain);
		return query(rootUrl+ "ips/set-custom-dns.json", 
				params, MandrillDedicatedIp.class);
