 ...
 * 
 */
package org.esarbanis.mandrill.api.senders;
...
import org.esarbanis.mandrill.api.senders.MandrillDomain.MandrillDomainVerificationInfo;
...
public class MandrillSendersApi extends MandrillSubContext {
	...
	public MandrillSendersApi(final String key, final String url, RequestDispatcher requestDispatcher, JsonSerializer jsonSerializer) {
